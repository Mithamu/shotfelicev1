...
scroll.init ({
    ...
    if(toggle.hash == "#service" || toggle.hash == "#profile" || toggle.hash == "#message" || toggle.hash == "#home") {
      return 0
    } else if(toggle.hash == "#contact") {
      return 100
    } else if(toggle.hash == "#photographing") {
      return 100
    }else if(toggle.hash == "#edit") {
      return 50
    }
	}
});
